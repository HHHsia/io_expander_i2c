...
#define MPU9250_SENSOR_ADDR                 0x68         /*!< Slave address of the MPU9250 sensor 20*/
#define MPU9250_WHO_AM_I_REG_ADDR           0x75        /*!< Register addresses of the "who am I" register 2E*/
...
/**
 * Read a sequence of bytes from a MPU9250 sensor registers
 */
...
/**
 * Write a byte to a MPU9250 sensor register
 */
...
void app_main(void)
{
    ...
    //mpu9250_register_read(MPU9250_WHO_AM_I_REG_ADDR, data, 1);
